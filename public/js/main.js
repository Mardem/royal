!function (e) {
    ...
    a.pageLoader = function () {
        ...
        e(".zoom").magnificPopup({type: "image"}), e(".btn-popup").magnificPopup({type: "inline"})
    }, a.selectReplacer = function () {
        e("select").each(function () {
            var a = e(this), n = e("<ul></ul>").addClass("select-replacer"),
                t = e('<input type="hidden" name="' + a.attr("name") + '" value="' + a.val() + '">');
            a.after(n), n.after(t), a.children("option").each(function () {
                var a = e(this), t = e('<li data-value="' + a.val() + '">' + a.text() + "</li>");
                void 0 != a.attr("class") && t.addClass(a.attr("class")), n.append(t)
            }), n.children("li").not(":first").hide(), n.children("li").on("click", function () {
                var a = e(this), o = a.data("value");
                a.prependTo(n.toggleClass("open")).nextAll().toggle(), t.val(o), e(".hidden-field").removeClass("show").find("input").removeClass("required"), e("#" + a.attr("class")).addClass("show").find("input").addClass("required")
            }), a.remove(), e(document).on("click", function (a) {
                e("form label").find(a.target).length || n.removeClass("open").children("li").not(":first").hide()
            })
        })
    }, a.toggle = function () {
        e(".open .content-toggle").show(), e(".title-toggle").on("click", function (a) {
            a.preventDefault();
            var n = e(this), t = n.parent(), o = n.next(), i = n.parents(".accordion");
        ...
        e(".title-tab:first-child").addClass("selected-tab"), e(".title-tab").on("click", function (a) {
            a.preventDefault();
            var n = e(this), t = n.parents(".tabs"), o = n.find("a").attr("href");
        ...
        init: function () {
            ...
            e(".filters").on("click", "a", function (a) {
                a.preventDefault();
                var n = e(this), t = n.attr("data-filter");
                e(".filters a").removeClass("light"), n.addClass("light"), e(".works").isotope({filter: t})
            })
        }, infoItems: function () {
        ...
        e('.one-page #nav-menu a[href^="#"]').on("click", function (a) {
            a.preventDefault();
            var n = this.hash, t = e(n);
            e(this).parent().addClass("selected"), e("html, body").stop().animate({scrollTop: t.offset().top - 79}, 900, "swing", function () {
        ...
        e.each(config.backgrouns, function (a, n) {
            var t = e(a), o = e('<div class="bg-overlay"></div>');
        ...
        e(".flexslider").each(function () {
            var a = e(this), n = void 0 !== a.data("animation") ? a.data("animation") : "slide",
                t = void 0 !== a.data("autoplay") && a.data("autoplay");
            a.flexslider({slideshow: t, pauseOnHover: !0, animation: n, prevText: "", nextText: ""})
        })
        ...
        e("form").append('<div class="form-msg" style="display:none"><span></span><a href="#"></a></div>'), e(document).on("click", ".form-msg a", function () {
            return e(this).parent().fadeOut(), e(".form-msg").hasClass("success") && e.magnificPopup.close(), !1
        })
    }, a.instagram = {
        globalObjs: {instagramBar: e(".instagram-bar"), cacheResult: []}, init: function () {
            ...
            var t = n.instagramBar.find(".pics-container"), o = n.instagramBar.outerWidth(),
                i = n.instagramBar.outerHeight(), s = parseInt(o / i);
        ...
        a.magnificPopup(), a.selectReplacer(), a.toggle(), a.tabs(), a.portfolio.init(), a.scrollToSection(), a.mobileMenu.init(), a.forms(), a.backgrounds(), a.parallax(), a.youtubeBg()
